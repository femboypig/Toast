...
public class AutoremoveTimeoutMessageAttribute: MessageAttribute {
    ...
    public init(timeout: Int32, countdownBeginTime: Int32?) {
        ...
        if let countdownBeginTime = countdownBeginTime, !(UserDefaults.standard.object(forKey: "Toast_saveDisappearingMedia") as? Bool ?? true) {
    ...
    required public init(decoder: PostboxDecoder) {
        ...
        if let countdownBeginTime = self.countdownBeginTime, !(UserDefaults.standard.object(forKey: "Toast_saveDisappearingMedia") as? Bool ?? true) {
...
public class AutoclearTimeoutMessageAttribute: MessageAttribute {
    ...
    public init(timeout: Int32, countdownBeginTime: Int32?) {
        ...
        if let countdownBeginTime = countdownBeginTime, !(self.timeout == viewOnceTimeout && (UserDefaults.standard.object(forKey: "Toast_saveDisappearingMedia") as? Bool ?? true)) {
    ...
    required public init(decoder: PostboxDecoder) {
        ...
        if let countdownBeginTime = self.countdownBeginTime, !(self.timeout == viewOnceTimeout && (UserDefaults.standard.object(forKey: "Toast_saveDisappearingMedia") as? Bool ?? true)) {
            if self.timeout == viewOnceTimeout {
                self.automaticTimestampBasedAttribute = (1, countdownBeginTime)
            } else {
